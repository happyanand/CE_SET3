...
public class TC_CE_005_SegmentedList extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE5(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage MarketingSegmentedList TC CE005 ***************");		  
		consumerpage.login_CE_validations();
		consumerpage.marketing_segmented_list();	
