...
public class TC_CE_076_Report_Live extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE76(CensusInfo ApplicantInfo)
		...
		if (tcTestData != null) {
	        ...
	        ApplicantInfo.EmailCampaign = tcTestData.getRow(1).getCell(3).getStringCellValue().toString();
		}

		System.out.println("******* Customer Engage Agency Agent_License TC CE046 ***************");		  
		consumerpage.login_CE_validations();
		consumerpage.report_LiveReport(ApplicantInfo); 
