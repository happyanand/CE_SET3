...
public class TC_CE_008_Marketing_CallCampaign extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE8(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage MarketingCall Campaign TC CE008 ***************");		  
		consumerpage.login_CE_validations();
        consumerpage.marketing_CallCampaign(ApplicantInfo);
