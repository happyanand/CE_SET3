...
public class MS_TS_007_TC_016_ScheduleLater_EmailCampaign extends AllScenarios_EG_TC {
	...
	public void EG_TC_016_ScheduleLater_EmailCampaign(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage Marketing Email Campaign ScheduleLater ***************");		  
		consumerpage.login_CE_validations();
		consumerpage.cti_Minimize();
		consumerpage.validate_ScheduleLater_Email_Campaign(ApplicantInfo);
