...
public class TC_CE_034_035_Sales_Policy_PolicyFilter_Export_AdvanceSearch extends AllScenarios_EG_TC{
	...
	SalesLeadPage SalesLeadPage = new SalesLeadPage(driver);
		...
		System.out.println("******* TC_CE_034_Sales_Policy_PolicyFilter ***************");		  
		consumerpage.login_CE_validations();
		SalesLeadPage.cttMinimize(); 
		SalesLeadPage.policy_Filter(ApplicantInfo);
