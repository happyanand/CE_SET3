...
public class TC_CE_006_Marketing_Template extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE6(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage MarketingTemplate TC CE006 ***************");		  
		consumerpage.login_CE_validations();
		consumerpage.marketing_Template(ApplicantInfo);
