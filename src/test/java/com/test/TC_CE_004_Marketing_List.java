...
public class TC_CE_004_Marketing_List extends AllScenarios_EG_TC {
	...
	public void EG_TC_CE4(CensusInfo ApplicantInfo)
		...
		System.out.println("******* Customer Engage MarketingList TC CE004 ***************");		  
		consumerpage.login_CE_validations();
		consumerpage.cti_Minimize();
		consumerpage.marketing_List(ApplicantInfo);
